...
public final class ImageSimilarity {
	...
	public ImageSimilarity(byte[] hashValue) {
	...
	public ImageSimilarity(String hashValue) {
		this(toBytes(hashValue));
	}
	

	public ImageSimilarity(BufferedImage src) {
		this(hashValue(src));
	}
	...
	/**
	 * 从压缩格式指纹创建{@link ImageSimilarity}对象
	 * 
	 * @param compactValue
	 * @return
	 */
	public static ImageSimilarity createFromCompact(byte[] compactValue) {
		return new ImageSimilarity(uncompact(compactValue));
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof ImageSimilarity) {
			return Arrays.equals(this.binaryzationMatrix,
					((ImageSimilarity) obj).binaryzationMatrix);
		} else
	...
	public float compare(String hashValue) {
		return compare(new ImageSimilarity(hashValue));
	}
	...
	public float compare(BufferedImage image2) {
		return compare(new ImageSimilarity(image2));
	}
	 ...
	 */
	public float compare(ImageSimilarity src) {
	 ...
	 * @param f1
	 * @param f2
	 * @return 返回相似度(0.0~1.0)，值越大，相似性越高，1.0：代表完全相似。
	 */
	...
	public static float compare(BufferedImage image1, BufferedImage image2) {
		return new ImageSimilarity(image1).compare(new ImageSimilarity(image2));
	}
	...
	public static void main(String args[]) {
		...
		try {
			// FingerPrint fp1 = new FingerPrint(ImageIO.read(new
			// File("C:/tmimage/huiguanjia/downloadimage/76/7613910.jpg")));
			// // FingerPrint fp2 =new FingerPrint(ImageIO.read(new
			// File("C:/tmimage/huiguanjia/downloadimage/76/7613901.jpg")));
			// FingerPrint fp2 =new FingerPrint(ImageIO.read(new
			// File("C:/tmimage/huiguanjia/downloadimage/76/7613851.jpg")));
			//
			// System.out.println(fp1.toString(true));
			// System.out.printf("sim=%f",fp1.compare(fp2));
			
//			FingerPrint fp3 = new FingerPrint(ImageIO.read(new File(
//					"C:/tmimage/test2/13509080.jpg")));
//			FingerPrint fp4 = new FingerPrint(ImageIO.read(new File(
//					"C:/tmimage/test2/13509167.jpg")));

			
			ImageSimilarity fp3 = new ImageSimilarity(ImageIO.read(new File(
					"C:/tmimage/test2/image2-2.jpg")));
			ImageSimilarity fp4 = new ImageSimilarity(ImageIO.read(new File(
					"C:/tmimage/test2/image6.jpg")));

			float result=fp3.compare(fp4);
			// System.out.println(fp3.toString(true));			
			System.out.printf("similarity=%f", result);
